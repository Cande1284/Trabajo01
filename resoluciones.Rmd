...
```
En este problema, Lucia evalúa tres alternativas para sus vacaciones (A: agencia, B: por cuenta propia, C: actividades locales) bajo tres escenarios de disponibilidad (Alta, Media, Baja), considerando los costes asociados a cada opción.
...
En resumen, si Lucia desea minimizar los costes y actuar con prudencia ante la incertidumbre de disponibilidad, la opción C es la más recomendable según todos los criterios aplicados
